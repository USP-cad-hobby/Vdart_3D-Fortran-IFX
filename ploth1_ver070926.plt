...
set rmargin  -1
set tmargin  -1
set locale "Danish_Denmark.1252"
...
GridDistance = 0.0
x = 0.0
## Last datafile plotted: "hpos.dat"
## Last plot command
plot 'c:\Users\Gaming-Z87\source\repos\Vdart3D_Fortran_mod\hpos.dat' u 5:($2==6 && $1==2 ?$6 :1/0) t 'H1 ' w l
#    EOF
